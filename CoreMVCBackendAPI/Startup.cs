...
using CoreMCVApplication.System.Roles;
using CoreMCVApplication.System.Users;
...
namespace CoreMVCBackendAPI
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<CoreMVCDbContext>(options =>
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Swagger CoreMVC v1");
            });
